...
-- ----------------------------
-- Table structure for stock_guan_jian_tees
-- ----------------------------
DROP TABLE IF EXISTS `stock_guan_jian_tees`;
CREATE TABLE `stock_guan_jian_tees`  (
  ...
  INDEX `stock_guan_jian_tees_user_id_foreign`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 646629 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

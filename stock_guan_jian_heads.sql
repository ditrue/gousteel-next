...
-- ----------------------------
-- Table structure for stock_guan_jian_heads
-- ----------------------------
DROP TABLE IF EXISTS `stock_guan_jian_heads`;
CREATE TABLE `stock_guan_jian_heads`  (
  ...
  `tech` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `stock_guan_jian_heads_user_id_foreign`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17272 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
